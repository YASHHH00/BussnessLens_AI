"""Food Delivery Plugin — Stub for v2."""
...
class FoodDeliveryPlugin(BaseDomainPlugin):
    @property
    def name(self) -> str: return "food_delivery"
    @property
    def display_name(self) -> str: return "Food Delivery"
    @property
    def version(self) -> str: return "0.0.0-stub"
    def register_fields(self, registry: BusinessFieldRegistry) -> None:
        raise NotImplementedError("Food Delivery plugin is planned for v2.")
